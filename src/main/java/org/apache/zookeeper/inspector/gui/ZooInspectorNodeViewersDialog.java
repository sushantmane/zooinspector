...
public class ZooInspectorNodeViewersDialog extends JDialog implements ListSelectionListener {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          if (answer == JOptionPane.YES_OPTION) {
            ...
            try {
              ...
              LOG.error("Error saving node veiwer configuration from file.", ex);
              JOptionPane.showMessageDialog(
                  ZooInspectorNodeViewersDialog.this,
    ...
    loadFileButton.addActionListener(e -> {
      ...
      if (result == JFileChooser.APPROVE_OPTION) {
        try {
          ...
          LOG.error("Error loading node veiwer configuration from file.", ex);
          JOptionPane.showMessageDialog(
              ZooInspectorNodeViewersDialog.this,
    ...
    setDefaultsButton.addActionListener(e -> {
      ...
      if (answer == JOptionPane.YES_OPTION) {
        ...
        try {
          ...
          LOG.error("Error setting default node veiwer configuration.", ex);
          JOptionPane.showMessageDialog(
              ZooInspectorNodeViewersDialog.this,
  ...
  public void valueChanged(ListSelectionEvent e) {
    ...
    if (index == -1) {
      ...
      downButton.setEnabled(index != viewersList.getModel().getSize());
    }
  }
}
